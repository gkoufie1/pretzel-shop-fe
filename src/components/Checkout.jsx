              ...
              <div className="border-t border-gray-200 pt-6">
                <div className="mb-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-sm text-yellow-800">
                    <strong>⚠️ Security Notice:</strong> This is a demo application. Do not enter real credit card information.
                    For production, integrate a secure payment processor like Stripe or PayPal.
                  </p>
                </div>
